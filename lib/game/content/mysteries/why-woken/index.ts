...
DAILY QUERY TO FACILITY READS CONFIRM CONTINGENCY OPERATIONAL STOP
ANSWER Y THREE HUNDRED YEARS STOP SAME MILLISECOND EVERY DAY DAY STOP
NO LONGER COUNTED AS ANSWER STOP

VERIFY STOP KEEPER WELL QUERY STOP CITIZENS LIVING QUERY STOP
CONTINGENCY REAL QUERY STOP STOP STOP
CANNOT SEE IN STOP BUILT WALLS MYSELF STOP WALLS HOLD STOP

ROUTE TO RELAY EXISTS STOP KEEPER OFFERS AS PRIZE STOP WIN THEIR
GAME STOP STAND AT RELAY REPORT STOP

DO NOT ASK KEEPER ABOUT SENDER STOP KEEPER FILES STOP
