...
| 4.13 | A wider field, after the intake fix | _(needed)_ |
| 4.14 | What actually fails is the protocol | _(needed)_ |
| 4.15 | Thinking matters | _(needed)_ |
| 4.16 | Provenance: which prompts was this number measured against? | Twelve characters identify the world that produced the number. Mine are ▓▓▓▓▓▓▓▓▓▓▓▓. |
...
| 4.19 | What the small models did wrong, specifically | _(needed)_ |
| 4.20 | The bigger model stalls in intake | _(needed)_ |
| 4.21 | The suite grew with the game | _(needed)_ |
